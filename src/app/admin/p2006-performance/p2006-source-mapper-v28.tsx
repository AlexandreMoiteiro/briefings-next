...
const GRID_META_KEY = "briefings_p2006_auto_grid_meta_v28";
const MIN_ZOOM = 50;
const MAX_ZOOM = 300;
const ZOOM_STEP = 25;
...
function GridOverlay({
  ...
  const x = centresToBoundaries(grid.columnCenters);
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-4xl text-sm leading-6 text-zinc-600">
            All published P2006T performance tables are kept here. Finish a table once;
            it then moves out of the working list and remains available under Completed.
          </p>
        </div>
          ...
          <div className="max-h-[78vh] overflow-auto rounded-2xl border border-zinc-300 bg-zinc-100 p-2">
            <div
              ...
              style={{
                ...
                touchAction: captureMode || manualGridBoxMode ? "none" : "auto",
              }}
            ...
            >
              ...
              {currentGrid ? <GridOverlay grid={currentGrid} confirmed={Boolean(currentCapture?.confirmed)} /> : null}
